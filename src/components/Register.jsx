...
function Register(){
  ...
  <button className="bg-teal-400 hover:bg-gray-100 text-gray-800 font-semibold  my-6 py-2 px-4 border border-gray-400 rounded shadow" onClick={()=>navigate(-1)}> Register</button>
  </form>
  <h6 className="text-white font-bold text-right mx-4 text-slate-400  hover:text-slate-100 self-right text-base font-sans" onClick={()=>navigate('/login')}> Login</h6>
   </div>
